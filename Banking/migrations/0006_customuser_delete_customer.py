# Generated by Django 5.2.7 on 2025-10-26 08:08
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('Banking', '0005_customer_id_alter_customer_customer_id'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('kyc_status', models.CharField(choices=[('PENDING', 'Pending Review'), ('VERIFIED', 'Verified'), ('REJECTED', 'Rejected'), ('UPLOAD_REQUIRED', 'KYC Documents Required')], default='UPLOAD_REQUIRED', max_length=20)),
                ('kyc_uploaded_at', models.DateTimeField(blank=True, null=True)),
                ('id_proof_document', models.CharField(blank=True, max_length=255)),
                ('address_proof_document', models.CharField(blank=True, max_length=255)),
